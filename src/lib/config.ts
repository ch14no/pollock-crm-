// M&A事業部固有のUI分岐で使う事業部名。deal_term/task_term等の
// カスタマイズ可能なラベル文字列ではなく、事業部そのものの識別に使うため
// 複数ファイルで直接この定数を参照する（文字列リテラルの重複・食い違いを防ぐ）
export const MA_DIVISION_NAME = 'M＆A事業部'
