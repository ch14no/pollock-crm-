...
export interface Database {
  public: {
    Tables: {
      ...
      companies: {
        Row: { id: string; name: string; corporate_number: string | null; website: string | null; ir_url: string | null; address: string | null; phone: string | null; industry: string | null; representative: string | null; employee_count: number | null; capital: number | null; established_on: string | null; note: string | null; created_at: string; updated_at: string }
        Insert: { name: string; corporate_number?: string | null; website?: string | null; ir_url?: string | null; address?: string | null; phone?: string | null; industry?: string | null; representative?: string | null; employee_count?: number | null; capital?: number | null; established_on?: string | null; note?: string | null }
        Update: { name?: string; corporate_number?: string | null; website?: string | null; ir_url?: string | null; address?: string | null; phone?: string | null; industry?: string | null; representative?: string | null; employee_count?: number | null; capital?: number | null; established_on?: string | null; note?: string | null }
      }
      contacts: {
