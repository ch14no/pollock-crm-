...
export const DEFAULT_DIVISION_STAGES: Record<string, DivisionStage[]> = {
  'div-1': [ // ITソリューション
    { id: 'リード',     name: 'リード',     sortOrder: 0, isWon: false, isLost: false, tabId: null },
    { id: '初回面談',   name: '初回面談',   sortOrder: 1, isWon: false, isLost: false, tabId: null },
    { id: '一次面談',   name: '一次面談',   sortOrder: 2, isWon: false, isLost: false, tabId: null },
    { id: '提案中',     name: '提案中',     sortOrder: 3, isWon: false, isLost: false, tabId: null },
    { id: '最終面談',   name: '最終面談',   sortOrder: 4, isWon: false, isLost: false, tabId: null },
    { id: '受注',       name: '受注',       sortOrder: 5, isWon: true,  isLost: false, tabId: null },
    { id: '失注',       name: '失注',       sortOrder: 6, isWon: false, isLost: true,  tabId: null },
  ],
  'div-2': [ // 人材
    { id: 'リード',       name: 'リード',       sortOrder: 0, isWon: false, isLost: false, tabId: null },
    { id: '初回面談',     name: '初回面談',     sortOrder: 1, isWon: false, isLost: false, tabId: null },
    { id: '提案中',       name: '提案中',       sortOrder: 2, isWon: false, isLost: false, tabId: null },
    { id: 'クロージング', name: 'クロージング', sortOrder: 3, isWon: false, isLost: false, tabId: null },
    { id: '受注',         name: '受注',         sortOrder: 4, isWon: true,  isLost: false, tabId: null },
    { id: '失注',         name: '失注',         sortOrder: 5, isWon: false, isLost: true,  tabId: null },
  ],
  'div-3': [ // 財務
    { id: 'リード',       name: 'リード',       sortOrder: 0, isWon: false, isLost: false, tabId: null },
    { id: '初回面談',     name: '初回面談',     sortOrder: 1, isWon: false, isLost: false, tabId: null },
  ...
  'div-4': [ // Bowers
    { id: 'リード',     name: 'リード',     sortOrder: 0, isWon: false, isLost: false, tabId: null },
    { id: 'ヒアリング', name: 'ヒアリング', sortOrder: 1, isWon: false, isLost: false, tabId: null },
    { id: '無料登録',   name: '無料登録',   sortOrder: 2, isWon: false, isLost: false, tabId: null },
    { id: 'トライアル', name: 'トライアル', sortOrder: 3, isWon: false, isLost: false, tabId: null },
    { id: '受注',       name: '受注',       sortOrder: 4, isWon: true,  isLost: false, tabId: null },
    { id: '失注',       name: '失注',       sortOrder: 5, isWon: false, isLost: true,  tabId: null },
  ],
  'div-5': [ // メディケア
    { id: 'リード',       name: 'リード',       sortOrder: 0, isWon: false, isLost: false, tabId: null },
    { id: '初回訪問',     name: '初回訪問',     sortOrder: 1, isWon: false, isLost: false, tabId: null },
    { id: '提案中',       name: '提案中',       sortOrder: 2, isWon: false, isLost: false, tabId: null },
    { id: 'クロージング', name: 'クロージング', sortOrder: 3, isWon: false, isLost: false, tabId: null },
    { id: '受注',         name: '受注',         sortOrder: 4, isWon: true,  isLost: false, tabId: null },
    { id: '失注',         name: '失注',         sortOrder: 5, isWon: false, isLost: true,  tabId: null },
